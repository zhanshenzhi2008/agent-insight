...
| v0.3 | 2026-07-03 | - | ⚠️ **部分条款已修订**，请**先阅读** [`00-revision-2026-07-03.md`](./00-revision-2026-07-03.md)：① `log_llm_*` 实际存储在 **llm-agent 工程的 MongoDB**，不在本工程库内 ② 本工程**不创建、不修改** llm-agent 任何代码 ③ 系统定位是**通用 BI 平台**，llm-agent 是 v1 内置模板包 |
